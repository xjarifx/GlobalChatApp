      ...
      <div className="flex h-[90vh] w-full max-w-md flex-col rounded-xl shadow-2xl bg-white p-6">
        ...
        {!username ? (
          ...
          <>
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`max-w-[80%] flex flex-col ${isUser ? "items-end" : "items-start"}`}>
                      ...
                      {isImage ? (
                        <div className={`rounded-lg overflow-hidden ${isUser ? "rounded-br-none" : "rounded-bl-none"}`}>
                          <img
                            src={msg.text}
            ...
            {/* Image preview section - add this */}
              ...
              <div className="mt-4 p-3 bg-gray-100 rounded-lg">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute bottom-2 right-2 bg-blue-500 hover:bg-blue-600 text-white rounded-full p-2 shadow-md"
                  >
                    {isUploading ? (
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <button
                ...
                disabled={isUploading}
                className="rounded-lg bg-gray-200 px-3 py-2 text-gray-700 hover:bg-gray-300 transform transition-all hover:scale-105 active:scale-95 shadow-md flex items-center justify-center"
                title="Select image"
              >
